angular.module('MetronicApp').controller('EmailPopupController', function ($rootScope,$filter, AdjusterPropertyClaimDetailsService,AuthHeaderService, $uibModal, $scope, AppraisalService, $translate, $translatePartialLoader) {
