angular.module('MetronicApp')
    ...
    .controller('AppraisalDetailsController', function ($rootScope, $scope, settings, $location, $translate, $translatePartialLoader, $window,
        ...
        VendorAssociateItemDetailsService, ThirdPartyLineItemDetailsService, PurchaseOrderService, SpeedCheckContactService) {
        ...
        function getAppraisalDetails() {
            ...
            details.then(function (success) {
                ...
                angular.forEach(appraisalDetails.attachments, function (ItemFile) {
                    ...
                    $scope.attachmentList.push({ "FileName": filename, "FilePath": name, "fileData" : ItemFile.multipartFiles });
        ...
        $scope.getAttachements = function(event){
          var b64Data = $(event.target).attr('data-filedata');
        ...
        function UpdateApprisal() {
            ...
            promis.then(function (success) {
                ...
                $location.path('/SpeedCheckContactAppraisal');
            }, function (error) {
                toastr.remove();
                $(".page-spinner-bar").addClass("hide");
                if (error.data.errorMessage != null && angular.isDefined(error.data.errorMessage)) {
            ...
            var out = $uibModal.open(
                {
                    ...
                    templateUrl: "views/SpeedCheckContact/Dashboard/Appraisals/EmailPopup.html",
        ...
        function AddUnderWriterPopup() {
            ...
            var out = $uibModal.open(
                {
                    animation: $scope.animationsEnabled,
                    templateUrl: "views/SpeedCheckContact/Dashboard/Appraisals/UnderwritterReviewPopup.html",
        ...
        function AddInsuranceAgentPopup() {
            ...
            var out = $uibModal.open(
                {
                    animation: $scope.animationsEnabled,
                    templateUrl: "views/SpeedCheckContact/Dashboard/Appraisals/InsuranceAgentReviewPopup.html",
