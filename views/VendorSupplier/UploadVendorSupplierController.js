angular.module('MetronicApp').controller('UploadVendorSupplierController', function ($translate, $window,
    $translatePartialLoader, $rootScope, $scope, $location, $interval,VendorSupplierService,
     $filter, $timeout) {
    ...
    $scope.fileControl;
    $translatePartialLoader.addPart('UploadVendorSupplier');
    $translate.refresh();
    $scope.ErrorMessage = "";
    $scope.FileDetails = {
        FileName: null,
    ...
    function StartUpload() {
        ...
        var UploadFile = VendorSupplierService.UploadSupplierExcelFile(data);
        UploadFile.then(function (success) {
            $scope.uploader.progress = 100;
            $interval.cancel($scope.timer);
            $scope.UserList = success.data.data.readVendorSupplier;
    ...
    function Verify() {
        ...
        var UploadItem = VendorSupplierService.UploadSupplier(paramList);
