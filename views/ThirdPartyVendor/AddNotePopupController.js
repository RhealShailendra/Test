angular.module('MetronicApp').controller('AddNotePopupController', function ($rootScope,$filter, AdjusterPropertyClaimDetailsService, $uibModal, $scope, $translate, $translatePartialLoader, objClaim) {
    ...
    $translate.refresh();
    $scope.CommonObj = { "claimNote": null, "ClaimId": objClaim.claimId, "itemId": angular.isDefined(objClaim.ItemId) ? objClaim.ItemId : null, "claimNumber": objClaim.ClaimNumber };
    $scope.fileName = null;
    $scope.FileType = null;
