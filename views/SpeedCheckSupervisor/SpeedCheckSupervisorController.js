angular.module('MetronicApp').controller('SpeedCheckSupervisorController', function ($rootScope, $scope, $filter, settings, $http, $location, $translate, $translatePartialLoader,
    AuthHeaderService) {

        $translatePartialLoader.addPart('SpeedCheckSupervisor');
        $translate.refresh();
