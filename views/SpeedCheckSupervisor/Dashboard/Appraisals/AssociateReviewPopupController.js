angular.module('MetronicApp').controller('AssociateReviewPopupController', function ($rootScope,$filter,$location, AdjusterPropertyClaimDetailsService, $uibModal, $scope, $translate, $translatePartialLoader,
    ...
    //set language 
    $translatePartialLoader.addPart('SpeedCheckAssociateReview');
    $translate.refresh();
    ...
    $scope.ok = function (e) {     
        var appraisalId = sessionStorage.getItem("appraisalId");
          ...
          data.append("userType", "SPEEDCHECK ASSOCIATE");
          console.log(data);
          var promis = AppraisalService.UpdateAppraisal(data);
          promis.then(function (success) {
              toastr.remove();
              toastr.success("The appraisal was submitted for SpeedCheck Assocoiate.", "Success");
