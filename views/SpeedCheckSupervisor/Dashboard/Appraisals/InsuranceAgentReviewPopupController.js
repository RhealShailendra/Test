angular.module('MetronicApp').controller('InsuranceAgentReviewPopupController', function ($rootScope,$filter,$location, AdjusterPropertyClaimDetailsService, $uibModal, $scope, $translate, $translatePartialLoader,
    ...
    $scope.ok = function (e) {     
        var appraisalId = sessionStorage.getItem("appraisalId");
          ...
          data.append("userType", "INSURANCE_AGENT");
          console.log(data);
          var promis = AppraisalService.UpdateAppraisal(data);
          promis.then(function (success) {
              toastr.remove();
              toastr.success("The appraisal was submitted to Insurance Agent ", "Success");
