angular.module('MetronicApp')
    ...
    .controller('AppraisalDetailsController', function ($rootScope, $scope, settings, $location, $translate, $translatePartialLoader, $window,
        ...
        VendorAssociateItemDetailsService, ThirdPartyLineItemDetailsService, PurchaseOrderService, SpeedCheckSupervisorService) {
        ...
        function getAppraisalDetails() {
            ...
            details.then(function (success) {
                ...
                if(appraisalDetails.supervisorReviewStatus==null || appraisalDetails.supervisorReviewStatus==0){
                ...
                if(appraisalDetails.supervisorReviewStatus==null || appraisalDetails.supervisorReviewStatus==0 &&
                    appraisalDetails.associateReviewStatus==1){
                    $scope.isAssignAppraisal = true;
                } else {
                    $scope.isAssignAppraisal = false;
                }
        ...
        function UpdateApprisal() {
            ...
            promis.then(function (success) {
                ...
                $location.path('/SpeedCheckSupervisorAppraisal');
                $(".page-spinner-bar").addClass("hide");
            }, function (error) {
                toastr.remove();
                $(".page-spinner-bar").addClass("hide");
            ...
            var out = $uibModal.open(
                {
                    ...
                    templateUrl: "views/SpeedCheckSupervisor/Dashboard/Appraisals/EmailPopup.html",
        ...
        function AddUnderWriterPopup() {
            ...
            var out = $uibModal.open(
                {
                    animation: $scope.animationsEnabled,
                    templateUrl: "views/SpeedCheckSupervisor/Dashboard/Appraisals/UnderwritterReviewPopup.html",
        ...
        function AddInsuranceAgentPopup() {
            ...
            var out = $uibModal.open(
                {
                    animation: $scope.animationsEnabled,
                    templateUrl: "views/SpeedCheckSupervisor/Dashboard/Appraisals/InsuranceAgentReviewPopup.html",
        ...
        $scope.AddSpeedCheckAssociatePopup = AddSpeedCheckAssociatePopup;
        function AddSpeedCheckAssociatePopup() {
            var appraisalDTO = {
                "AddedComparables": $scope.AddedComparables,
                "ItemDetails": $scope.ItemDetails,
                "Comparables": $scope.Comparables,
            ...
            var out = $uibModal.open(
                {
                    animation: $scope.animationsEnabled,
                    templateUrl: "views/SpeedCheckSupervisor/Dashboard/Appraisals/AssociateReviewPopup.html",
                    controller: "AssociateReviewPopupController",
                    backdrop: 'static',
                    keyboard: false,
                    resolve:
                    {
        ...
        function assignAppraisal() {
            ...
            if (associateEmployee.length != 0 ||associateEmployee != null || associateEmployee != undefined) {
                ...
                assign.then(function (success) {
                    ...
                    $location.path('/SpeedCheckSupervisor');
                }, function (error) {
                    toastr.remove();
                    $(".page-spinner-bar").addClass("hide");
                    if (error.data.errorMessage != null && angular.isDefined(error.data.errorMessage)) {
