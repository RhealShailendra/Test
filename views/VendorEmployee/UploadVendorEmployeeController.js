angular.module('MetronicApp').controller('UploadVendorEmployeeController', function ($translate, $window,
    $translatePartialLoader, $rootScope, $scope, $location, $interval,UploadVendorEmployeeService,
     $filter, $timeout) {
    ...
    $scope.fileControl;
    $translatePartialLoader.addPart('UploadVendorEmployee');
    $translate.refresh();
    $scope.ErrorMessage = "";
    $scope.FileDetails = {
        FileName: null,
    ...
    function StartUpload() {
        ...
        var UploadFile = UploadVendorEmployeeService.UploadVendorDetailsFile(data);
    ...
    function Verify() {
        ...
        var UploadItem = UploadVendorEmployeeService.SaveVendorDetails(paramList);
