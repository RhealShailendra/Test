angular.module('MetronicApp').controller('NewOfficeController', function ($rootScope,$filter, $scope, $http, $location, $translatePartialLoader, NewOfficeService, $translate) {
    ...
    function init() {
        ...
        StateList.then(function (success) {$scope.ddlStateList = success.data.data;}, function (error) {$scope.ErrorMessage = error.data.errorMessage; });
    ...
    function SaveBranchDetails() {
        ...
        if ($scope.SelectedBranch.Id !== null && angular.isDefined($scope.SelectedBranch.Id)) {
            ...
            var param = {
                ...
                "branchCode": $scope.SelectedBranch.branchCode,
                ...
                "adminDetails":
                    {
                        "id": $scope.SelectedBranch.AdminDetails.id
                    },
    ...
    function BindData() {
        ...
        $scope.SelectedBranch.OfficeCode = $scope.BranchDetails.branchCode;
            ...
            $scope.SelectedBranch.DefaultTimeZone = $scope.BranchDetails.defaultTimeZone;
    ...
    //    sessionStorage.setItem("EmpName", item.firstName+" "+item.lastName);
    //    $location.url('NewEmployee');
    //    $scope.commonObj.RoleId = [];
    //    $scope.OrignialRoleListOfEmployee = angular.copy(item.roles);
    //    angular.forEach(item.roles, function (roleObj) {
    //        $scope.commonObj.RoleId.push( roleObj.id );
    //    });
    //    $scope.AddNewContact = false;
    //    $scope.EditContact = true;
    //    $scope.SelectedMember = {};       
    //    $scope.SelectedMember = angular.copy(item);
    //};
