//
angular.module('MetronicApp').controller('ContentCategoriesController', function ($rootScope, $scope, $uibModal, settings, $http, $location, $translate, $translatePartialLoader, CategoryService) {
