angular.module('MetronicApp').controller('NewEmployeeController', function ($rootScope, $filter, $scope, $http, $location, $translatePartialLoader, $translate, NewOfficeService) {
                ...
                "employeeDetails": [
                  {
                      ...
                      "designation":
                          {
                              "id":$scope.EmpDetails.designation.id
                          },
                      "reportingManager":
                            {
                                "id": $scope.EmpDetails.reportingManager.id
                            },
