angular.module('MetronicApp').controller('ServiceRequestInvoicesAssociateController', function ($translate, $translatePartialLoader, $scope, $rootScope, $state, settings,
    $location, ServiceRequestInvoicesAssociateService) {
    ...
    $scope.InvoiceListToBePaid = [];
    $scope.SelectedInvoices = [];
    $scope.VendorDetails = {};
    $scope.Payment = {};
    $scope.StateList = [];
    $scope.CurrentClaimTab = 'InvoicesToBePaid';//Show active tab at page load
    ...
    function init() {
        ...
        var getInvoiceList = ServiceRequestInvoicesAssociateService.GetInvoiceList(param);
        ...
        var getStateList = ServiceRequestInvoicesAssociateService.getStates(stateparam);
    ...
    function GetVendorDetails(vendorid)
    {
       ...
       getVendorDetailsOnID = ServiceRequestInvoicesAssociateService.getVendorDetails(param);
    ...
    $scope.MakePayment = function () {
        ...
        var makePayment = ServiceRequestInvoicesAssociateService.MakePayment(param);
    ...
    function GotoInvoiceDetails(item, invoice) {
        sessionStorage.setItem("ServiceRequestBackURL", "ServiceRequestInvoicesAssociate");
