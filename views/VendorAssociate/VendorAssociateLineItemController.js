angular.module('MetronicApp').controller('VendorAssociateLineItemController', function ($rootScope, $window, $scope, settings, $uibModal, $location, $translate, $translatePartialLoader, VendorAssociateClaimDetailsService,
    ...
    function init() {
        ...
        getItemDetailsOnId.then(function (success) {
            ...
            var GetExistingComparablesFromDb = VendorAssociateItemDetailsService.GetExistingComparablesFromDb(param);
            GetExistingComparablesFromDb.then(function (successComparables) {
                $scope.Comparables = successComparables.data.data;
                CheckForAlreadyAddedComparables();
        ...
        var GetInvoice = VendorAssociateItemDetailsService.getInvoiceList(param);
        ...
        var getReciptList = VendorAssociateItemDetailsService.getReceiptList(param);
    ...
    function SaveNewlyAddedComparables()//SaveNewComparables
    {
        ...
        SaveNewComparables.then(function (success) {
            ...
            if ($scope.ItemDetails.salvageItem) {
                ...
                var SalvageItem = VendorAssociateItemDetailsService.SaveSalvageItem(SalvageParam);
            ...
            GetExistingComparablesFromDb.then(function (success) {
                $(".page-spinner-bar").addClass("hide");
                toastr.remove()
                toastr.success($translate.instant("ComparablesAddSuccess"), $translate.instant("CommonConfirmationHeading"));
    ...
    function SendMessagePopUp($event) {
        ...
        if ($scope.Comparables.comparableItems == null) {
            ...
            var obj = {
                ...
                "RegNumber":$scope.InsuranceCompanyDetails.company.companyCrn,
                "claim": {
