angular.module('MetronicApp').controller('GemLabClaimDetailsController', function ($translate, $translatePartialLoader, $rootScope, $log, $scope,
    settings, $http, $timeout, $location, $uibModal, $filter, AuthHeaderService, GemLabClaimDetailsService, ItemValueService) {

    $scope.items = $rootScope.items; $scope.boolValue = true;
    $translatePartialLoader.addPart('GemlabClaimDetails');
    $translate.refresh();
    ...
    function GetInvoicesAgainstAssignment() {
        ...
        var GetAssingmentInvoices = GemLabClaimDetailsService.GetAssignmentInvoices(param);
    ...
    function GetAssignMentDetails() {
        ...
        var GetAssingmentDetails = GemLabClaimDetailsService.GetVendorassignmentDetails(param);
    ...
    function GetNotes() {
        ...
        var getpromise = GemLabClaimDetailsService.getClaimNotes(param);
    ...
    function GetStatusInvoiceDetails() {
        ...
        var getpromise = GemLabClaimDetailsService.getClaimsStatusInvoiceDetails(param);
        getpromise.then(function (success) {
    ...
    function GetClaimStatusList() {
        var claimStatusList = GemLabClaimDetailsService.GetClaimStatusList();
        claimStatusList.then(function (success) { $scope.ClaimStatusList = success.data.data; $scope.SetCurrentStageID(); }, function (error) { })
    }
    ...
    function GetParticipantsList() {
        ...
        var getpromise = GemLabClaimDetailsService.getVendorsListAgainstClaim(param);
        getpromise.then(function (success) {
    ...
    function GetParticipantTypeList() {
        $(".page-spinner-bar").removeClass("hide");
        var getpromise = GemLabClaimDetailsService.getParticipantType();
        getpromise.then(function (success) {
    ...
    function GetClaimAttachment() {
        ...
        var getpromise = GemLabClaimDetailsService.getClaimAttachments(param);
        getpromise.then(function (success) {
            $scope.ClaimAttachments = [];
    ...
    function GetPostLostItems() {
        ...
        var getpromise = GemLabClaimDetailsService.getPostLostItemsForVendor(param);
        getpromise.then(function (success) {
            $scope.FiletrLostDamageList = [];
    ...
    function GetServiceRequestList() {
        ...
        var getServiceRequestList = GemLabClaimDetailsService.getServiceRequestedList(paramServoceRequest);
    ...
    function GetEventList() {
        ...
        var EventListPromise = GemLabClaimDetailsService.GetEventList(paramClaimId);
    ...
    function getClaimParticipant() {
        ...
        var param = { "claimNumber": $scope.CommonObj.ClaimNumber }
        var getpromise = GemLabClaimDetailsService.getVendorsAgainstClaimDetails(param);
        getpromise.then(function (success) {
    ...
    function GetClaimInsuranceDetails() {
        ...
        var GetInsurancDetails = GemLabClaimDetailsService.GetInsuranceDetails(param);
    ...
    $scope.AddEvent = function () {
        ...
        var EventPromise = GemLabClaimDetailsService.CreateEvent(paramEvent);
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    ...
                    var response = GemLabClaimDetailsService.removePostLostItem(paramIdList);
                    response.then(function (success) { //Filter list and remove item     
                        ...
                        var response = GemLabClaimDetailsService.getFiletrLostDamageList(paramLostDamageList);
    ...
    $scope.AddnewItemPopup = function () {
        ...
        var out = $uibModal.open(
            {
                animation: $scope.animationsEnabled,
                templateUrl: "views/ThirdPartyVendor/AddNewLostDamageItem.html",
        ...
        var out = $uibModal.open(
            {
                animation: $scope.animationsEnabled,
                size: "lg",
                templateUrl: "views/ThirdPartyVendor/ItemPayout.html",
    ...
    $scope.AddNote = function (e) {
        ...
        var getpromise = GemLabClaimDetailsService.addClaimNoteWithOptionalAttachment(data);
        getpromise.then(function (success) {
    ...
    $scope.AddClaimAttachment = function () {
        ...
        var getpromise = GemLabClaimDetailsService.addClaimAttachment(data);
        getpromise.then(function (success) {
            $scope.Status = success.data.status;
            if ($scope.Status == 200) {
                toastr.remove();
    ...
    function GetSubCategory() {
        if ($scope.selected.category !== null && angular.isDefined($scope.selected.category)) {
            ...
            var respGetSubCategory = GemLabClaimDetailsService.getSubCategory(param);
    ...
    function GetCategory() {
        var getpromise = GemLabClaimDetailsService.getCategories();
        getpromise.then(function (success) { $scope.DdlSourceCategoryList = success.data.data; }, function (error) { $scope.ErrorMessage = error.data.errorMessage; });
    }
    ...
    $scope.SaveItemDetails = function (itemid) {
        if (!angular.isUndefined(itemid)) {
            ...
            var UpdatePostLoss = GemLabClaimDetailsService.UpdatePostLoss(param);
            ...
            param.append('file', null);
            var SavePostLossItem = GemLabClaimDetailsService.AddPostLossItem(param);
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if (result) {
                    ...
                    var response = GemLabClaimDetailsService.DeleteLostDamageItem(paramId);
                    response.then(function (success) { //Filter list and remove item   
                        toastr.remove();
    ...
    function CreatePendingtask() {
        ...
        var CreateTask = GemLabClaimDetailsService.CreatePendingtask(param);
    ...
    function GoToInvoiceDetails(invoice) {
        ...
        if (invoice.invoiceNumber != null && angular.isDefined(invoice.invoiceNumber)) {
            ...
            var getpromise = GemLabClaimDetailsService.getInvoiceDetails(param);
            getpromise.then(function (success) {
    ...
    function SuperVisorReview() {
        ...
        var addSuperVisorReview = GemLabClaimDetailsService.SendClaimForSupervisorReview(param);
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if (result) {
                    ...
                    var promis = GemLabClaimDetailsService.deleteMediaFile(param);
    ...
    function changeTaxRate() {
        ...
        var taxRatePromis = GemLabClaimDetailsService.changeTaxRate(params);
    ...
    function GetStateList() {
        ...
        var GetStates = GemLabClaimDetailsService.getStates(param);
    ...
    function UpdateCompanyDetails() {
        ...
        var updatePolicyHolder = GemLabClaimDetailsService.updatePolicyHolder(param);
    ...
    function reOpenClaim() {
        ...
        var promis = GemLabClaimDetailsService.reOpenClaim(param);
        promis.then(function (success) {
    ...
    $scope.showSalvageTab = showSalvageTab;
    function showSalvageTab() {
        $(".page-spinner-bar").removeClass("hide");
        $scope.ContentTab = 'Salvage';
        $(".page-spinner-bar").addClass("hide");
    };

    $scope.showClaimSummeryTab = showClaimSummeryTab;
    function showClaimSummeryTab() {
        $(".page-spinner-bar").removeClass("hide");
        $scope.ContentTab = 'ClaimSummery';
        $(".page-spinner-bar").addClass("hide");
    };
