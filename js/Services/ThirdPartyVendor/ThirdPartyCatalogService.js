angular.module('MetronicApp').service('ThirdPartyCatalogService', ['$http', '$rootScope', 'AuthHeaderService', function ($http, $rootScope, AuthHeaderService) {
    ...
    this.DeleteCatalogItem = function (param) {
        var DeleteItem = $http({
            method: "DELETE",
            url: AuthHeaderService.getApiURL() + "web/delete/vendor/catalog/items",
            data: param,
            headers: AuthHeaderService.getHeader()
        });
        return DeleteItem;
