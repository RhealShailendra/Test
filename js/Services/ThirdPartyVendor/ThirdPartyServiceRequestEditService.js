angular.module('MetronicApp').service('ThirdPartyServiceRequestEditService', ['$http', '$rootScope', 'AuthHeaderService', function ($http, $rootScope, AuthHeaderService) {
    ...
    this.AssignServiceRequest = function (param) {
        var Assignresponse = $http({
            method: "Post",
            url: AuthHeaderService.getApiURL() + "web/servicerequest/assign/vendorassociate",
            data: param,
            headers: AuthHeaderService.getHeader()
        });
    ...
    //Get List Of Vendor Asscociates For Assing Service Request Screen
    this.GetVendorAssociatesList = function () {
        var Assignresponse = $http({
            method: "Get",
