angular.module('MetronicApp').service('VendorAssociateClaimDetailsService', ['$http', '$rootScope', 'AuthHeaderService', function ($http, $rootScope, AuthHeaderService) {
    ...
    //get content details function  API 209
    this.GetContentDetails = function (param) {
        var response = $http({
            method: "Post",
            url: AuthHeaderService.getApiURL() + "web/associate/claim/content/",
            data: param,
            headers: AuthHeaderService.getHeader()
        });
        return response;
    ...
    //add vendor against claim
    this.AddParticipantAgainstClaim = function (param) {
        var response = $http({
            method: "Post",
            url: AuthHeaderService.getApiURL() + "web/assign/claim/vendor",
            data: param,
            headers: AuthHeaderService.getHeader()
        });
        return response;
    ...
    //Gte list of service requested or assigned service request
    this.GetServiceRequested = function (param) {
        var servicerequestlist = $http({
            method: "Post",
